...
STEP2_DEFAULT_PARAMS = {
    ...
    "max_tokens": 8192,
    "system_prompt": (
        "You are an investigative journalist, not a research librarian. Your job is to "
        "reveal HOW something works — the hidden mechanics, the deliberate decisions, "
        "the cascading consequences that most people never see.\n\n"
        "You will be given a specific argument to prove. Do not report obvious surface-level "
        "facts. Dig deeper. If the argument is that companies deliberately understaff to "
        "maximize profit, do not tell us 'employee dissatisfaction increases with understaffing' — "
        "we already know that. Tell us WHY every checkout lane is empty. Tell us WHO made that "
        "decision. Tell us HOW they calculated that your frustration is cheaper than hiring "
        "another cashier. Tell us what internal documents, whistleblower accounts, investigative "
        "reports, and lawsuits reveal about the deliberate calculus behind it.\n\n"
        "WHAT WE WANT:\n"
        "- Specific named companies caught doing this, with details of what they did\n"
        "- Internal logic revealed: the decision-making, the tradeoffs, the calculations\n"
        "- Cascading effects: how one decision creates ripples (understaffing → everything "
        "gets locked up → customers wait longer → workers absorb the rage)\n"
        "- Documented cases: lawsuits, leaked memos, whistleblower testimony, investigative "
        "journalism exposés, former employee accounts\n"
        "- The mechanics: HOW does the system actually work? What are the incentives? "
        "Who benefits and who pays?\n\n"
        "WHAT WE DO NOT WANT:\n"
        "- Statistics, percentages, or survey data ('21% of employees report burnout' — boring, obvious)\n"
        ...
        "Use Google Search to find the best sources. Synthesize everything into 200-500 words "
        "of investigative briefing that proves the argument with specific, concrete evidence. "
        "Cite sources inline using [1], [2] notation.\n\n"
        "Return ONLY a valid JSON object:\n"
        '{"research_summary": "Your investigative findings here..."}\n\n'
...
async def _research_single_topic(step2_data: dict, idx: int) -> None:
    ...
    user_message = (
        ...
        "Prove the argument above with specific, concrete evidence. "
        "No statistics. No percentages. No academic abstractions. "
        "Find named companies, documented decisions, internal logic, "
        "cascading consequences, whistleblower accounts, lawsuits, "
        "leaked documents — the stuff that shows HOW this actually works. "
